...
namespace TrabajoPC2
{
    ...
    {
        private double desc;
        public Bebidas(string nombre, string categoria, int cantidad, double precio, double desc) : base(nombre, categoria, cantidad, precio)
        {
            this.desc = desc;
        }
        public Bebidas(string nombre, string categoria, int cantidad) : base(nombre, categoria, cantidad)
        {
        }
